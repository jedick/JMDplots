...
# B. subtilis biofilm
Rscript --vanilla --default-packages=JMDplots -e "runMaximAct('transcriptome', bg_organism = 'Bsu', seed=1:$NSEED)"
Rscript --vanilla --default-packages=JMDplots -e "runMaximAct('proteome', bg_organism = 'Bsu', seed=1:$NSEED)"

# Drosophila embryo or adult
Rscript --vanilla --default-packages=JMDplots -e "runMaximAct('fly_embryo', bg_organism = 'Dme', seed=1:$NSEED)"
Rscript --vanilla --default-packages=JMDplots -e "runMaximAct('fly_adult', bg_organism = 'Dme', seed=1:$NSEED)"

# Drosophila developmental time course
Rscript --vanilla --default-packages=JMDplots -e "runMaximAct('fly_development', bg_organism = 'Dme', seed=1:$NSEED)"
