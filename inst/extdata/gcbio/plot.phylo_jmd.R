...
### Function modified by Jeffrey M. Dick 20220420
### ape version of original function: 5.5
### Purpose of modification: adjust placement of labels
### See jmd comment below
...
#                 font = font, srt = srt, cex = cex, col = tip.color)
            ### Modified by jmd 20220420
            text(xx.tmp + lox + 2300, yy.tmp + loy - 0.3, x$tip.label, adj = c(adj, 0),
                 font = font, srt = srt, cex = 1, col = tip.color)
        } else {
