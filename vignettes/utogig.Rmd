...
## Chemical and thermodynamic analysis of evolutionary divergence along redox gradients (Figure 4 and Table S6)
...
```{r utogig_H2_Eh, message = FALSE}
logaH2_15 <- -15
pH <- 7
logK1 <- subcrt(c("H2", "hydrogen"), c(-1, 1), T = 25)$out$logK
logfH2 <- logK1 + logaH2_15
logK3 <- subcrt(c("H2O", "H2", "oxygen"), c(-1, 1, 0.5), T = 25)$out$logK
logfO2 <- 2 * (logK3 - logaH2_15)
logK3 <- subcrt(c("H2", "H+", "e-"), c(-1, 2, 2), T = 25)$out$logK
