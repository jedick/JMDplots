...
# For 10^-2 pH2
logpH2 <- -2
print(paste0("Given logpH2 = ", logpH2, ", logaH2 = ", round(logpH2 + logK, 1), " at equilibrium"))
# For 0.55 ppmv H2
logpH2 <- log10(0.55e-6)
print(paste0("Given logpH2 = ", round(logpH2, 2), ", logaH2 = ", round(logpH2 + logK, 1), " at equilibrium"))
```
