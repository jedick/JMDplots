...
**Update:** In July 2024, the taxonomic classifications and reference database were updated to use GTDB release 220.
There are small changes in the figures compared to the preprint, which used GTDB release 207.
