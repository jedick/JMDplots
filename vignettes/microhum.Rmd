...
```{r genomes_genera}
GTDB_taxonomy <- read.csv(system.file("extdata/RefDB/GTDB/taxonomy.csv.xz", package = "JMDplots"))
print(paste("GTDB:", nrow(GTDB_taxonomy), "genomes and", length(unique(GTDB_taxonomy$genus)), "genera"))
UHGG_taxonomy_full <- read.csv(system.file("extdata/RefDB/UHGG/fullset/taxonomy.csv.xz", package = "JMDplots"))
...
UHGG_taxonomy <- read.csv(system.file("extdata/RefDB/UHGG/taxonomy.csv.xz", package = "JMDplots"))
