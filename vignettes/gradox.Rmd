...
This vignette from the R package [JMDplots](https://github.com/jedick/JMDplots) version `r packageDescription("JMDplots")$Version` contains plots from the paper by <a href="https://doi.org/10.3389/fmicb.2019.00120" title="Changes in carbon oxidation state of metagenomes along geochemical redox gradients">Dick et al. (2019)</a>.
