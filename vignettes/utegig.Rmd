...
## Thaumarchaeota `r ZC` and thermodynamic analysis (Figure 5)
```{r utegig5, message = FALSE, results = "hide", out.width='100%', fig.width = 17, fig.height = 12, out.extra = 'class="full-width"', dpi = 100}
utegig5()
```
