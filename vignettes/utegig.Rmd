...
## Convert `r logaH2` to Eh and oxygen fugacity
```{r utegig_H2_O2_Eh}
logaH2_15 <- -15
pH <- 7
...
Eh <- convert(pe, "Eh")
logK2 <- suppressMessages(subcrt(c("H2O", "H2", "oxygen"), c(-1, 1, 0.5), T = 25)$out$logK)
logfO2_15 <- 2 * (logK2 - logaH2_15)
logaH2_30 <- -30
logfO2_30 <- 2 * (logK2 - logaH2_30)
print(paste0("Given logaH2 = ", logaH2_15, " and pH = ", pH, ", Eh = ", round(1000 * Eh), " mV at equilibrium"))
print(paste0("Given logaH2 = ", logaH2_15, ", logfO2 = ", round(logfO2_15, 2), " at equilibrium"))
print(paste0("Given logaH2 = ", logaH2_30, ", logfO2 = ", round(logfO2_30, 2), " at equilibrium"))
```
