---
title: "Chemical metrics of estimated microbial community proteomes from 16S rRNA and RefSeq sequences (2022)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Chemical metrics of estimated microbial community proteomes from 16S rRNA and RefSeq sequences (2022)}
...
`r ZC` for genera that are abundant in produced fluids of shale gas wells:
...
`r ZC` for *Halanaerobium* species (numeric names are NCBI taxids):
