...
## Shale gas datasets (Figure 3)
```{r geo16S3, message = FALSE, results = "hide", out.width='100%', fig.width = 9, fig.height = 6, pngquant = pngquant}
geo16S3()
```

## Taxonomic levels (Figure 4)
```{r geo16S4, message = FALSE, results = "hide", out.width='100%', fig.width = 8, fig.height = 6, pngquant = pngquant}
geo16S4()
```
