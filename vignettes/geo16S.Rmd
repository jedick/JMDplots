...
This vignette runs the code to make the plots from the following preprint:
...
Get the chemical parameters including `r ZC` for particular genera that are abundant in produced fluids of shale gas wells:
...
subset(taxon_parameters, group %in% c("Halanaerobium", "Thermoanaerobacter"))
```
...
## Changes of abundance and chemical parameters at different taxonomic levels (Figure 4)
