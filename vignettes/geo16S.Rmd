...
> Dick JM, Tan J. 2021. Genomic evidence for chemical convergence between redox conditions and microbial community composition. Submitted manuscript.
>
...
write.csv(dat1, "Source_Data_1.csv", row.names = FALSE, quote = FALSE)
write.csv(dat2, "Source_Data_2.csv", row.names = FALSE, quote = FALSE)
write.csv(dat3, "Source_Data_3.csv", row.names = FALSE, quote = FALSE)
write.csv(dat4, "Source_Data_4.csv", row.names = FALSE, quote = FALSE)
```
