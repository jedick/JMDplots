...
## Correlations between `r ZC` estimated from metagenomes and 16S rRNA sequences (Figure S3)
```{r geo16S_S3, message = FALSE, results = "hide", out.width='100%', fig.width = 10, fig.height = 8, out.extra = 'class="full-width"', pngquant = pngquant}
geo16S_S3()
```
