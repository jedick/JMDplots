...
> Dick JM, Tan J. 2021. Chemical links between redox conditions and microbial community proteomes estimated from 16S rRNA and reference protein sequences. Submitted manuscript.
>
...
```{r geo16S_S3, message = FALSE, results = "hide", out.width='100%', fig.width = 14, fig.height = 7, pngquant = pngquant}
geo16S_S3()
```

## Correlations between `r ZC` estimated from metagenomes and 16S rRNA sequences (Figure S4)
```{r geo16S_S4, message = FALSE, results = "hide", out.width='100%', fig.width = 10, fig.height = 8, out.extra = 'class="full-width"', pngquant = pngquant}
geo16S_S4()
```
