...
The plots in this vignette are modified from the preprint in the following way: All taxids are weighted equally (instead of by number of reference sequences) to calculate the mean amino acid composition for taxonomic groups.
...
**Data source:** NCBI Reference Sequence (RefSeq) database [@OWB+16]. **Numbered symbols**: (1) Thermococci, (2) Methanococci, (3) Archaeoglobi, (4) Nanohaloarchaea, (5) Halobacteria, (6) Clostridia.
