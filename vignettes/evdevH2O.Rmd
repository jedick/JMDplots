...
## Chemical parameter range of human, fly, and bacterial proteomes (Figure S2)
```{r evdevH2OS2, message = FALSE, results = "hide", out.width='100%', fig.width = 8, fig.height = 5, out.extra='class="full-width"', pngquant = pngquant, dpi = 100}
evdevH2OS2()
```
