---
title: "Thermodynamic model for water activity and redox potential in evolution and development (2021)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Thermodynamic model for water activity and redox potential in evolution and development (2021)}
...
After that time, the following minor changes were made to the plots in this vignette:
...
* 2021-08-24
    Lines showing the cumulative mean were removed from Figure 1.
    These lines are not discussed in the text.
