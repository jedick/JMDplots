---
title: "Thermodynamics in evolution and development (2021)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Thermodynamics in evolution and development (2021)}
...
## Chemical and thermodynamic analysis of *B. subtilis* biofilm transcriptome and proteome (Figure 4)
...
## Number of genes in each phylostratum (Figure S1)
```{r evdevH2OS1, message = FALSE, results = "hide", out.width='100%', fig.width = 8, fig.height = 4, pngquant = pngquant}
evdevH2OS1()
```
