...
```{r orp16S1, message = FALSE, results = "hide", out.width='80%', fig.align='center', fig.width = 6, fig.height = 4, pngquant = pngquant}
orp16S1()
```
...
## Comparison of Eh7 and O~2~ as predictors of carbon oxidation state (Figure S3)
```{r orp16S_S3, message = FALSE, results = "hide", out.width='100%', fig.width = 7, fig.height = 6, pngquant = pngquant, dpi = 100}
orp16S_S3()
```
