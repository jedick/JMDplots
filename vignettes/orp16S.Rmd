...
## Distinct associations between `r ZC` and Eh7 or O~2~ (Figure 6)
```{r orp16S6, message = FALSE, results = "hide", out.width='100%', fig.width = 7, fig.height = 6, pngquant = pngquant, dpi = 100}
orp16S6()
```
