...
## `r ZC` of reference proteomes compared with metaproteomes and with growth conditions (Figure 2)
```{r orp16S_2, message = FALSE, results = "hide", out.width='100%', fig.width = 8, fig.height = 3.5, out.extra = 'class="full-width"', pngquant = pngquant, dpi = 100}
orp16S_2()
```
...
## Most abundant genera at low and high Eh7 in geothermal and hyperalkaline areas (Figure 7)
```{r orp16S_7, message = FALSE, results = "hide", out.width='100%', fig.align='center', fig.width = 8.5, fig.height = 5, pngquant = pngquant, dpi = 100}
orp16S_7()
```
