...
file <- system.file("extdata/OBIGT/OldAA.csv", package = "JMDplots")
add.OBIGT(file, c("[Gly]", "[UPBB]"))
...
Groups of datasets are considered that have similar chemical features, i.e. changes in `r zc` and _n_<sub>`r h2o`</sub>.
...
*Updates to these datasets and plots were made for a <b>[new paper in 2021](canH2O.html)</b>.*
