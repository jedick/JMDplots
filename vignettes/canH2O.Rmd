...
## Quantile plot for proteins coded by differentially expressed genes in aneuploid yeast cells (Figure 4)
...
## Scatterplots of `r ZC` and `r nH2O` vs phylostrata for HPA datasets (Figure S4)
