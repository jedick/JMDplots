---
title: "Eight plots from water in cancer paper (2020)"
output: 
...
## Scatterplots of hypoxia scores and `r ZC` or `r nH2O` for TCGA or HPA datasets (Figure S4)
```{r canH2OS4, message = FALSE, fig.align='center', out.width='75%', fig.width = 6, fig.height = 6, pngquant = pngquant}
canH2OS4()
```
