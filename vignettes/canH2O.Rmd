...
## `r nH2O` from stoichiometric hydration state and amino acid biosynthesis reactions (Figure 5)
```{r canH2O5, message = FALSE, fig.align='center', out.width='75%', fig.width = 6, fig.height = 3, pngquant = pngquant}
canH2O5()
```
...
## Plots with `r nH2O` and `r nO2` of amino acid biosynthesis reactions (Figure S4)
