...
## Differentially expressed genes in aneuploid and osmotically shocked yeast cells (Figure 5)
```{r canH2O5, message = FALSE, results = "hide", fig.align='center', out.width='80%', fig.width = 5, fig.height = 4, pngquant = pngquant}
canH2O5()
```
...
## Compositional analysis of phylostrata representing Liebeskind et al. gene ages (Figure S3)
```{r canH2OS3, message = FALSE, results = "hide", fig.align='center', out.width='100%', fig.width = 9, fig.height = 5, pngquant = pngquant}
canH2OS3()
```

## Scatterplots of `r ZC` and `r nH2O` vs phylostrata for TCGA and HPA datasets (Figure S4)
```{r canH2OS4, message = FALSE, fig.align='center', out.width='75%', fig.width = 8, fig.height = 8, pngquant = pngquant}
canH2OS4()
```
