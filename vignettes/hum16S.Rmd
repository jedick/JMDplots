---
title: "Chemical characteristics of human microbiomes (2023)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Chemical characteristics of human microbiomes (2023)}
...
> Dick JM. 2023. Chemical characteristics of human microbiomes inferred from multi-omics data. Manuscript in preparation.
> 
...
```{r hum16S_1, message = FALSE, out.width='100%', fig.align='center', fig.width = 7, fig.height = 5, pngquant = pngquant, dpi = 100}
hum16S_1()
```
...
```{r hum16S_2, message = FALSE, out.width='100%', fig.width = 8, fig.height = 6, pngquant = pngquant, dpi = 100}
hum16S_2()
```
...
```{r hum16S_3, message = FALSE, out.width='100%', fig.width = 15, fig.height = 12, pngquant = pngquant, dpi = 100}
hum16S_3()
```
...
```{r hum16S_4, message = FALSE, out.width='100%', fig.width = 8, fig.height = 6, pngquant = pngquant, dpi = 100}
hum16S_4()
```
