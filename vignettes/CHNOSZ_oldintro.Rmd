---
title: "An Introduction to CHNOSZ (old version)"
...
output:
  ...
  tufte::tufte_book:
    ...
    latex_engine: xelatex
vignette: >
  %\VignetteIndexEntry{An Introduction to CHNOSZ (old version)}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
bibliography: CHNOSZ_vig.bib
link-citations: yes
csl: elementa.csl
---
...
We see that at 200 °C (473.15 K) the second phase is stable; this one is automatically used by CHNOSZ for this diagram.
...
file.copy("CHNOSZ_rubisco.svg", fig_path(".svg"))
...
#  datfile <- system.file("extdata/misc/CHNOSZ_rubisco.csv", package = "CHNOSZ")
#  fastafile <- system.file("extdata/protein/CHNOSZ_rubisco.fasta", package = "CHNOSZ")
...
#  devSVGTips("CHNOSZ_rubisco.svg", toolTipMode=0, title="Rubisco")
#  par(cex=1.4)
