---
title: "Evolutionary oxidation of proteins (2025)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Evolutionary oxidation of proteins (2025)}
...
> Dick JM et al. 2025. Evolutionary oxidation of proteins. Manuscript in preparation.
...
## Evolutionary oxidation of ancestral Rubiscos and thermodynamic prediction of redox boundaries around the GOE (Figure 4)
```{r genoGOE4, message = FALSE, results = "hide", out.width='100%', fig.width = 9, fig.height = 11, pngquant = pngquant}
genoGOE_4()
```
...
## Evolutionary oxidation and relative stabilities for genomes with S-cycling genes (Figure 5)
```{r genoGOE5, message = FALSE, results = "hide", out.width='100%', fig.width = 6.5, fig.height = 10, pngquant = pngquant}
genoGOE_5()
```
