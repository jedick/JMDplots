---
title: "Earth's oxygenation recorded in genomes (2025)"
output: 
  rmarkdown::html_vignette:
    mathjax: null
vignette: >
  %\VignetteIndexEntry{Earth's oxygenation recorded in genomes (2025)}
...
```{r genoGOE3, message = FALSE, results = "hide", out.width='100%', fig.width = 9, fig.height = 11, pngquant = pngquant}
genoGOE_3()
```
...
```{r genoGOE4, message = FALSE, results = "hide", out.width='100%', fig.width = 6.5, fig.height = 10, pngquant = pngquant}
genoGOE_4()
```
...
```{r genoGOE5, message = FALSE, results = "hide", out.width='100%', fig.width = 7, fig.height = 5.5, pngquant = pngquant}
genoGOE_5()
```
