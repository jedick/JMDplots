...
*Panels (c) to (f):* See the vignettes `canprot::mkvig("osmotic_bact")` and `canprot::mkvig("osmotic_halo")`. Links to static vignettes for website: [osmotic_bact](../../canprot/doc/osmotic_bact.html) and [osmotic_halo](../../canprot/doc/osmotic_halo.html).
